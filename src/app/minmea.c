...
uint8_t
minmea_checksum(const char *sentence)
{
...
bool
minmea_check(const char *sentence, bool strict)
{
	uint8_t checksum = 0x00;
...
bool
minmea_scan(const char *sentence, const char *format, ...)
{
	bool result = false;
	bool optional = false;
	va_list ap;
...
bool
minmea_talker_id(char talker[3], const char *sentence)
{
	char type[6];
...
minmea_sentence_id(const char *sentence, bool strict)
{
...
bool
minmea_parse_rmc(struct minmea_sentence_rmc *frame, const char *sentence)
{
...
bool
minmea_parse_gga(struct minmea_sentence_gga *frame, const char *sentence)
{
...
bool
minmea_parse_gsa(struct minmea_sentence_gsa *frame, const char *sentence)
{
...
bool
minmea_parse_gll(struct minmea_sentence_gll *frame, const char *sentence)
{
...
bool
minmea_parse_gst(struct minmea_sentence_gst *frame, const char *sentence)
{
...
bool
minmea_parse_gsv(struct minmea_sentence_gsv *frame, const char *sentence)
{
...
bool
minmea_parse_vtg(struct minmea_sentence_vtg *frame, const char *sentence)
{
...
bool
minmea_parse_zda(struct minmea_sentence_zda *frame, const char *sentence)
{
...
int
minmea_gettime(struct timespec *ts, const struct minmea_date *date, const struct minmea_time *time_)
{
